...
#ifndef _DFF_META_TAG_EDITOR_H_
#define _DFF_META_TAG_EDITOR_H_
...
class dff_editor : public tagseditor {
    public:
        dff_editor();
        virtual ~dff_editor();
    ...
    private:
        dffeditor *mDffEditor;
        dff_editor(const dff_editor &);
        dff_editor &operator=(const dff_editor &);
};

}  // namespace android

#endif  // _DFF_META_TAG_EDITOR_H_