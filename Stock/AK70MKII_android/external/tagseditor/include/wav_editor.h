...
#ifndef _WAV_META_TAG_EDITOR_H_
#define _WAV_META_TAG_EDITOR_H_
...
class wav_editor : public tagseditor {
    public:
        wav_editor();
        virtual ~wav_editor();
    ...
    private:
        waveditor *mWavEditor;
        wav_editor(const wav_editor &);
        wav_editor &operator=(const wav_editor &);
};

}  // namespace android

#endif  // _WAV_META_TAG_EDITOR_H_