...
extern FLAC__StreamMetadata *grabbag__picture_parse_specification(const char *spec, const char **error_message);
extern FLAC__StreamMetadata *grabbag__picture_parse_buffer_specification(const char *buffer, const unsigned long length, const char **error_message);
extern int testImageInsertFlac(const char *prefix);
