...
extern int16_t *paranoia_read(cdrom_paranoia *p, int *exit_ripping, void (*callback)(long, int));
extern int16_t *paranoia_read_limited(cdrom_paranoia *p, int *exit_ripping,
		void (*callback)(long, int), int maxretries);
