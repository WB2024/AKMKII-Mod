...
#define SCSI_READ_SPEED_INVALID				0
#define SCSI_READ_SPEED_SLOW				1
#define SCSI_READ_SPEED_NORMAL			2
#define SCSI_READ_SPEED_FAST					3
#define SCSI_READ_SPEED_EXTRA_SLOW		4
#define SCSI_READ_SPEED_ULTRA_SLOW		5

// 2017.07.07 iriver-eddy
#define CDROM_TYPE_V1					0
#define CDROM_TYPE_V2					2
...
typedef struct cdrom_drive{
  ...
  int error_retry;
  int report_all;
  int exit_ripping;	// 2014.11.14 iriver-eddy
...
extern int cdda_eject(cdrom_drive *d);  // 2014.04.22 jhlim
// 2014.07.31 iriver-eddy
extern int cdda_eject_lock(cdrom_drive *d, int lock);
...
__attribute__((__unused__)) static const char *strerror_tr[]={
  "Success",
