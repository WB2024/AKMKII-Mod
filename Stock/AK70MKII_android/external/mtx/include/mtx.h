...
#if HAVE_SCSI_SG_H
#  include "../../bionic/libc/common/scsi/scsi.h"//<scsi/scsi.h>
#  include "../../bionic/libc/common/scsi/scsi_ioctl.h"///<scsi/scsi_ioctl.h>
#  include "../../bionic/libc/common/scsi/sg.h"/ //<scsi/sg.h>
