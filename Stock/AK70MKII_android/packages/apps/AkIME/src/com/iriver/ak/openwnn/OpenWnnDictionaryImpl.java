...
//            mDbOpenHelper = null;
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#setInUseState
     */
    ...
    public void setInUseState( boolean flag ) {
        if( flag ) {
            if( mDbDic == null ) {
                mDbOpenHelper = new OpenWnnSQLiteOpenHelper(this.mContext, mDicFilePath);
        ...
        case WnnDictionary.SEARCH_LINK:
            ...
            if( wnnWord != null ) {
                ...
                for( int i = 0 ; i < queryArgsTemp.length ; i++ ) {
                    ...
                    // yunsuk
//                    Log.i(getClass().getSimpleName(), "name : " + queryArgsTemp[ i ]);
                }
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#getUserDictionaryWords
     */
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#getConnectMatrix
     */
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#getPOS
     */
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#clearUserDictionary
     */
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#clearLearnDictionary
     */
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#addWordToUserDictionary
     */
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#removeWordFromUserDictionary
     */
    ...
    /**
     * @see com.iriver.ak.openwnn.WnnDictionary#learnWord
     */
