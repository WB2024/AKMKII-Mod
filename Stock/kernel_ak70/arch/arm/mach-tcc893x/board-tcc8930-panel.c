...
#ifdef CONFIG_LCD_S6E63M0X01
#define DEFAULT_BACKLIGHT_BRIGHTNESS	6
#elif CONFIG_LCD_AK380DISP
#define DEFAULT_BACKLIGHT_BRIGHTNESS	6
#elif CONFIG_LCD_AKJR2DISP
#define DEFAULT_BACKLIGHT_BRIGHTNESS	6
#elif CONFIG_LCD_N070ICN
#define DEFAULT_BACKLIGHT_BRIGHTNESS	20
#else
#define DEFAULT_BACKLIGHT_BRIGHTNESS	20
#endif
...
#ifdef CONFIG_LCD_S6E63M0X01
static struct platform_device s6e63m0x01_lcd = {
	.name	= "s6e63m0x01_lcd",
	.dev	= {
...
#ifdef CONFIG_LCD_AK380DISP
static struct platform_device ak380lcd_lcd = {
	.name	= "lcd_ak380lcd",
	.dev	= {
		.platform_data	= &lcd_pdata,
	},
...
#ifdef CONFIG_LCD_AKJR2DISP
static struct platform_device akjr2lcd_lcd = {
	.name	= "lcd_akjr2lcd",
	.dev	= {
		.platform_data	= &lcd_pdata,
	},
...
#ifdef  CONFIG_LCD_N070ICN
static struct platform_device n070icn_lcd = {
	.name	= "n070icn_lcd",
	.dev	= {
		.platform_data	= &lcd_pdata,
	},
...
#ifdef CONFIG_LCD_YM240DN2AL
static struct platform_device ym240dn2al_lcd = {
	.name	= "ym240dn2al_lcd",
	.dev	= {
		.platform_data	= &lcd_pdata,
	},
...
#ifdef CONFIG_LCD_AK380DISP
	case PANEL_ID_AK380:
		platform_device_register(&ak380lcd_lcd);
		break;
#endif

#ifdef CONFIG_LCD_AKJR2DISP
	case PANEL_ID_AKJR2:
		platform_device_register(&akjr2lcd_lcd);
		break;
#endif

#ifdef CONFIG_LCD_N070ICN
	case PANEL_ID_N070ICN:
		platform_device_register(&n070icn_lcd);
		break;
#endif

#ifdef CONFIG_LCD_S6E63M0X01
	case PANEL_ID_S6E63M0X01:
		platform_device_register(&s6e63m0x01_lcd);
		break;
#endif
        
#ifdef CONFIG_LCD_YM240DN2AL
	case PANEL_ID_YM240DN2AL:
		platform_device_register(&ym240dn2al_lcd);
		break;
#endif
