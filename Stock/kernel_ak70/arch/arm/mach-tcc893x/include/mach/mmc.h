...
#if defined(CONFIG_MMC_TCC_NORMAL_MODE)
...
#elif defined(CONFIG_MMC_TCC_DDR_MODE)
#define MMC_MAX_CLOCK_SPEED 48000000 // [downer] M140105 fixed DDR mode freq.
#else
	#define MMC_MAX_CLOCK_SPEED 48000000 
#endif
...
#define SD30_OFF        0
#define SD30_ON         1
#define SD30_ENABLE     2
#define SD30_DISABLE    3
