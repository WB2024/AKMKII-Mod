...
// !!! 아래 포트는 하드웨어에서 정의 되지 않은 포트.
// 일단 빌드 에러 나지 않토록 함.
// 각 담당자 정리 바람.

#ifdef _AK_REMOVE_
#define GPIO_AUDIO_SW_MUTE      	(0) // FIX_ME_LATER
#define GPIO_HP_BAL_MUTE 		    (0) // FIX_ME_LATER  
#define	GPIO_N2V8_EN				(0)	// FIX_ME_LATER
#define GPIO_AUDIO_N5V_EN			(0)	// FIX_ME_LATER
#define	GPIO_OPAMP_4V_EN			(0)	// FIX_ME_LATER
#endif
...
#define GPIO_DRAM_PWR_EN		TCC_GPA(1) //OK
#define GPIO_DRAM_V_CTL			TCC_GPA(2) //OK
...
//					GPIO Group B
//********************************************************
#define	GPIO_LCD_RESET			TCC_GPB(28)	
...
#define GPIO_OP_TX_PWEN          	TCC_GPD(2) //OK  
...
#define GPIO_OPTIC_TX_DET      	TCC_GPE(18) //OK
...
#define	GPIO_TSP_PWEN 			TCC_GPF(1) //OK 	

#define	GPIO_BT_DEV_WAKE 			TCC_GPF(2) //OK 	BT_WAKEUP
#define	GPIO_WIFI_BT_PWR_EN		TCC_GPF(4)	
...
#define	GPIO_CHG_ADP_MODE		TCC_GPF(7)	//OK Charger IC, MAX8677A
#define	GPIO_CHG_USB_MODE		TCC_GPF(8)	//OK Charger IC, MAX8677A
...
#define GPIO_KEY_BACK				TCC_GPG(11)	//  OK 	REV
#define GPIO_KEY_NEXT				TCC_GPG(13)	// OK	FF
