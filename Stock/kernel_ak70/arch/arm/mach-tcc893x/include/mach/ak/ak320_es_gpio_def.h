 ...
 *   2015-09-15
 */
#ifndef __AK320_ES_GPIO_DEF_H__
#define __AK320_ES_GPIO_DEF_H__

//AK320 PORTMAP DEFINE.
#define GPIO_HP_DET				TCC_GPA(2)
#define	GPIO_OPTIC_TX_DET		TCC_GPA(3)

#define	GPIO_KEY_VOL_DOWN			TCC_GPA(5) // TCC_GPB(24)
#define	GPIO_KEY_VOL_UP		TCC_GPA(6) //TCC_GPB(25)
...
//					GPIO Group D
//********************************************************
#define POGO_BAL_MUTE           TCC_GPD(3)
