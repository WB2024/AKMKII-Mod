    ...
    */
    ...
    for (i=0 ; i<MAX_TCC_PLL ; i++) {
        ...
        if (stClockSource[i]) {
            ...
            if (stClockSource[i] < stMinPLLRate) {
                stMinPLLRate = stClockSource[i];
                stMinPLLCh = i;
            }
        }
...
static unsigned int tca_ckc_setcpu(unsigned int freq)
{
    ...
    switch (div_num) {
        case 0:
        case 1: div_value = 0x10000; break;
        case 2: div_value = 0x10100; break;
        case 3: div_value = 0x11100; break;
        case 4: div_value = 0x11110; break;
        case 5: div_value = 0x51110; break;
        case 6: div_value = 0x51510; break;
        case 7: div_value = 0x55510; break;
        case 8: div_value = 0x55550; break;
        case 9: div_value = 0x75550; break;
        case 10: div_value = 0x75750; break;
        case 11: div_value = 0x77750; break;
        case 12: div_value = 0x77770; break;
        case 13: div_value = 0xF7770; break;
        case 14: div_value = 0xF7F70; break;
        case 15: div_value = 0xFFF70; break;
        default: div_value = 0xFFFF0; break;
    }
    switch(stMinPLLCh) {
        case 0:
        case 1:
    ...
    pCKC->CLKCTRL0.nREG = (pCKC->CLKCTRL0.nREG & 0xFFF00000) | div_value | pll_ch;
#else
