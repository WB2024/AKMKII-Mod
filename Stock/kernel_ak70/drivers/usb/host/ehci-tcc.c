...
#if 0 //jimi.test.1031
                gpio_request(GPIO_USB20_HOST_EN, "xmos_usb_on");
                tcc_gpio_config(GPIO_USB20_HOST_EN, GPIO_OUTPUT | GPIO_FN(0));
                gpio_direction_output(GPIO_USB20_HOST_EN, 0);
                gpio_set_value(GPIO_USB20_HOST_EN, 1); //HIGH ACTIVE
                printk("jimi--------------------->XMOS usb on(usb host20)\n");
//jimi.test auto setup
#if 0
                ...
                gpio_set_value(GPIO_USB_PWR_EN, 1); //HIGH ACTIVE
                printk("jimi--------------------->usb pwr on\n");

                gpio_request(GPIO_USB_PWR_EN, "usb_pwr_on");
                tcc_gpio_config(GPIO_USB_PWR_EN, GPIO_OUTPUT | GPIO_FN(0));
                gpio_direction_output(GPIO_USB_PWR_EN, 0);
                gpio_set_value(GPIO_USB_PWR_EN, 0); //HIGH ACTIVE
                printk("jimi--------------------->usb pwr off\n");
#endif

#if 0 //remove for internal
...
#if 0 //jimi.test.1031
                gpio_request(GPIO_USB20_HOST_EN, "xmos_usb_off");
                tcc_gpio_config(GPIO_USB20_HOST_EN, GPIO_OUTPUT | GPIO_FN(0));
                gpio_direction_output(GPIO_USB20_HOST_EN, 0);
                gpio_set_value(GPIO_USB20_HOST_EN, 0); //HIGH ACTIVE
                printk("jimi--------------------->XMOS usb off(usb host20)\n");
#if 0 //remove for internal
//jimi.test auto setup
                gpio_request(GPIO_OTG_5V5_EN, "otg_pwr_en");
                tcc_gpio_config(GPIO_OTG_5V5_EN, GPIO_OUTPUT | GPIO_FN(0));
                gpio_direction_output(GPIO_OTG_5V5_EN, 0);
                gpio_set_value(GPIO_OTG_5V5_EN, 0);
                printk("jimi--------------------->OTG power off\n");
#endif
