...
#ifdef USE_LOWER_CLOCK_FOR_DVFS //jimi.test.0103
static int g_is_card_type_sdxc=0; //0:no 1:yes

int mmc_is_card_type_sdxc(void)
{
	return g_is_card_type_sdxc;	
}
EXPORT_SYMBOL(mmc_is_card_type_sdxc);
#endif
