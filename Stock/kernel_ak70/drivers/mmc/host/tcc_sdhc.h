...
#define TCC_MMC_REQ_USE_DMA	(1<<2)	/* Use DMA for this req. */
    ...
    struct timer_list bounce_timer; /* [downer] A131230 */
    struct timer_list sd_poweroff_timer; /* [downer] A140121 */
    struct timer_list sd_eject_timer;    /* [downer] A140510 */
    
    int init_complete;          /* [downer] A131230 */
    ...
    struct early_suspend early_suspend; /* [downer] A131205 */    
};
