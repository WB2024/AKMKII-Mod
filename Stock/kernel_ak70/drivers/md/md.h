...
#define MAX_RAID_DISK (8)
struct ak_raid_info
{
	int level;
	int raid_disks;

	char recovery_type[16];
	int is_resync;
...
extern struct ak_raid_info g_ak_raid_status;  
extern struct ak_raid_disk_stat g_ak_raid_disks[MAX_RAID_DISK];
