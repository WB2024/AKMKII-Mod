...
#define DEFAULT_CORE_LOCK_PERIOD 50000 /* 200 ms */
 ...
 */
#define DEFAULT_MIN_SAMPLE_TIME 3000
static unsigned long min_sample_time;

/*
 * The sample rate of the timer used to increase frequency
 */
#define DEFAULT_TIMER_RATE 1000//40000; //20000;
...
int get_cpu_boost(void)
{
    return boost_val;
}
EXPORT_SYMBOL(get_cpu_boost);
