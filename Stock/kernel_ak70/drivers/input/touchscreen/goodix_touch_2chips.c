...
static void initial_irq(void)
{
	...
	if(system_rev == 0x1000)
	{
		...
		tcc_gpio_config(TCC_GPB(11), GPIO_FN(0));
		gpio_direction_input(TCC_GPB(11));
		tcc_gpio_config_ext_intr(INT_EINT2, EXTINT_GPIOB_11);
	}
#endif

#ifdef CONFIG_CHIP_TCC8935 || defined(CONFIG_CHIP_TCC8935S) || defined(CONFIG_CHIP_TCC8933S) || defined(CONFIG_CHIP_TCC8937S)
	if(system_rev == 0x2000)
	{
		gpio_request(TCC_GPE(13), "tsc_int");
		tcc_gpio_config(TCC_GPE(13), GPIO_FN(0));
		gpio_direction_input(TCC_GPE(13));
