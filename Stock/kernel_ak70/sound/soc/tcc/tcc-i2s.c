...
#define TCC_I2S_RATES (SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_11025 |\
...
static struct snd_soc_dai_driver tcc_i2s_dai[] = {
	...
	//            .formats = SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_IEC958_SUBFRAME_LE,},  //should be change? phys:32 width:16
			.formats = SNDRV_PCM_FMTBIT_S16_LE |SNDRV_PCM_FMTBIT_S24_LE |  SNDRV_PCM_FMTBIT_S32_LE | SNDRV_PCM_FMTBIT_S24_3LE,},  //should be change? phys:32 width:16
            
        .capture = {
            .channels_min = 2,
            .channels_max = 2,
            .rates = TCC_I2S_RATES,
            .formats = SNDRV_PCM_FMTBIT_S16_LE|SNDRV_PCM_FMTBIT_S24_LE}, //should be change? phys:32 width:16
        .ops   = &tcc_i2s_ops,
    },
    [__SPDIF_DEV_NUM__] =
    {
